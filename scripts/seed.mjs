...
const PROPERTIES = (landlord_id) => [
  ...
  { title: "Apartment in Saddar", city: "Rawalpindi", address: "The Mall, Saddar",
    type: "apartment", bedrooms: 2, bathrooms: 1, area_sqft: 950, monthly_rent: 45000, deposit: 90000,
    lat: 33.5980, lng: 73.0470, is_verified: false,
    description: "Affordable two-bedroom in Saddar, close to public transport and bazaars." },
  { title: "Family home in Wapda Town", city: "Faisalabad", address: "Block A, Wapda Town",
    type: "house", bedrooms: 3, bathrooms: 2, area_sqft: 1800, monthly_rent: 70000, deposit: 140000,
    lat: 31.4180, lng: 73.1090, is_verified: true,
    description: "Quiet residential street, dedicated parking, gas and water available." },
  { title: "Commercial shop on MA Jinnah Road", city: "Karachi", address: "MA Jinnah Road",
    type: "commercial", bedrooms: 0, bathrooms: 1, area_sqft: 600, monthly_rent: 150000, deposit: 300000,
    lat: 24.8650, lng: 67.0290, is_verified: true,
    description: "Ground floor commercial unit with high foot traffic." },
