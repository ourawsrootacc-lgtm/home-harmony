...
export default function Browse() {
  ...
  useEffect(() => {
    ...
    let query = supabase
      .from("properties")
      .select("id,title,city,address,monthly_rent,bedrooms,bathrooms,area_sqft,type,is_verified,lat,lng,property_images(url)")
      .eq("status", "active")
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      ...
      <div className="rounded-xl border bg-card p-3 mb-6 flex flex-wrap gap-2 items-center">
        ...
        <Select value={city || "all"} onValueChange={(v) => update("city", v === "all" ? "" : v)}>
